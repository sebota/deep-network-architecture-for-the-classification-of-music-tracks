import models
from utils import prepare_data_seq_train, shuffle, prepare_data_cnn_train, prepare_data_spec_train

# x_train_med_seq, y_train_med_seq, x_test_med_seq, y_test_med_seq, x_val_med_seq, y_val_med_seq = prepare_data_seq_train()
x_train_med_cnn, y_train_med_cnn, x_test_med_cnn, y_test_med_cnn, x_val_med_cnn, y_val_med_cnn = prepare_data_cnn_train()
...
models.model_cnn_rnn(x_train_med_cnn, y_train_med_cnn, x_test_med_cnn, y_test_med_cnn, x_val_med_cnn, y_val_med_cnn)
...
# models.model_gru(x_train_med_cnn, y_train_med_cnn, x_test_med_cnn, y_test_med_cnn, x_val_med_cnn, y_val_med_cnn)
